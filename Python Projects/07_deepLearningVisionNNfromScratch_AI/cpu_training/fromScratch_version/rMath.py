# ==================================================
#  Rmath: Math Library for Scratch Implementation
# ==================================================
# The Rmath library handles all the mathematical functions
# and operations needed for the scratch version of the neural
# network. It provides the core computations and algorithms,
# supporting the neural network's functionality with Python lists.
#
# This library was created to help understand the math behind
# deep learning by implementing the fundamental calculations
# for the original list-based version.
# ==================================================
