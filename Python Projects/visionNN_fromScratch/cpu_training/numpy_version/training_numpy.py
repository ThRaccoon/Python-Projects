...
# ==================================================
# This implementation uses NumPy to replace Python lists
# with ndarrays, offering faster and more efficient array
# computations. While it still runs on the CPU, it
# significantly improves speed and memory usage compared
# to the original list-based version. The main goal is
# to achieve better performance while remaining compatible
# with systems that lack GPU support.
# ==================================================
