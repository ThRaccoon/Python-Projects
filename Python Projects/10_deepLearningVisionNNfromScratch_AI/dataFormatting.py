...
# Data Formatting
# ==================================================
# This script is responsible for formatting the training
# and testing data for the neural network. It preprocesses
# the raw pixel data, ensuring it is properly structured and
# standardized for input into the network.
