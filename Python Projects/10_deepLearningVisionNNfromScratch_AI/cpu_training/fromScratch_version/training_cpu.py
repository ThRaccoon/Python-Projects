...
# ==================================================
# This implementation of the neural network is able to
# learn but is slow and inefficient due to the use of
# CPU and Python lists. It was primarily created to
# understand how deep learning and neural networks work.
#
# The implementation has been optimized using NumPy and
# CuPy. NumPy replaces Python lists with ndarrays for
# more efficient calculations on the CPU. CuPy (v12.4)
# adds GPU support, significantly accelerating computations.
# ==================================================
